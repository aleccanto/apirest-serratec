...
public class DetalhesPedidoController {
	...
	@GetMapping("/{numeroPedido}/produtos")
	public ResponseEntity<List<ProdutoDTOResponse>> getProdutos(@PathVariable String numeroPedido) throws ItemNotFoundException{
		return ResponseEntity.ok(service.getProdutos(numeroPedido));
	}
}
